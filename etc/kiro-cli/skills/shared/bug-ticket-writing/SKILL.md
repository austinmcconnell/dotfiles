---
name: bug-ticket-writing
description: Write clear, well-structured bug tickets with precise language, evidence, and testable acceptance criteria. Use when creating bug reports, writing bug tickets, or reviewing bug ticket quality.
---
...
Write bug tickets that are specific, evidence-backed, and actionable. Every bug ticket should
clearly communicate what's broken, why it's broken, and how to verify the fix.

## When to Use This Skill

- Creating new bug reports or bug tickets
- Reviewing or improving existing bug ticket quality
- Converting informal bug reports into structured tickets
- Helping others write better bug descriptions
