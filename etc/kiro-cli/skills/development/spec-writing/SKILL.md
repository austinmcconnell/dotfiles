...
Implementation guides include code examples, before/after comparisons, exact file changes, and
detailed testing instructions. Specs focus on requirements, architecture, and decisions.
...
See [the spec template](references/spec-template.md) for full template. Delete sections that don't
