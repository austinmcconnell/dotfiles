...
| Variant | SoC/CPU | RAM  | Key Differentiator   | Status                |
| ------- | ------- | ---- | -------------------- | --------------------- |
| Model A | Chip    | X GB | What makes it unique | Active / Discontinued |
...
One paragraph: what is the single best reason to buy this product family? Be specific about which
variant and why.
...
- **Official:** Cases, PSUs, expansion boards, etc.
- **Third-party:** Compatible accessories, community designs
- **Ecosystem maturity:** How easy is it to find parts and support?

## Community Reception

- **Source/forum 1:** Summary of sentiment
...
| Variant | Price (USD) | Where to Buy     |
| ------- | ----------- | ---------------- |
