...
ln -sfv "$DOTFILES_DIR/etc/sublime-text/JsPrettier.sublime-settings" "$HOME/Library/Application Support/Sublime Text/Packages/User"
ln -sfv "$DOTFILES_DIR/etc/sublime-text/Fmt.sublime-settings" "$HOME/Library/Application Support/Sublime Text/Packages/User"
...
ln -sfv "$DOTFILES_DIR/etc/sublime-text/lsp_library_installer.py" "$HOME/Library/Application Support/Sublime Text/Packages/User"
if is-macos; then
