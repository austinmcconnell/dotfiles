...
install_if_needed "exiftool" "formula"
...
install_if_needed "watch" "formula"
...
if is-macos; then
    ...
    install_if_needed "camo-studio" "cask" "personal"
    ...
    install_if_needed "stay" "cask"
    install_if_needed "steam" "cask" "personal"
